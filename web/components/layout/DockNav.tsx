  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-6 z-40 flex justify-center px-4">
      <motion.div
        ...
        className="pointer-events-auto flex items-center gap-1 rounded-2xl border border-white/10 bg-zinc-950/85 px-2 py-2 shadow-2xl shadow-black/40 backdrop-blur-xl"
      >
        {ITEMS.map((item) => {
